			...
			<div class="footer-nav__col footer-nav__col--info">
				...
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">The brand: <p> Welcome to Avenue Fashion, your global fashion hub! Explore curated collections inspired by the iconic styles of London, New York, and Paris.</p> </a>
					</li>
